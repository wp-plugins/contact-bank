					...
					<div id="tabs-nohdr-1"  style="display:none;">
						<div  id="div_advanced_<?php echo $dynamicId; ?>">
							<div class="layout-control-group" id="password_label_<?php echo $dynamicId; ?>" style="display: none">
								...
								<div class="layout-controls">
									<textarea class="layout-span11" id="ux_password_label_<?php echo $dynamicId; ?>" placeholder="<?php _e( "Enter Label Style", contact_bank ); ?>" name="ux_password_label_<?php echo $dynamicId; ?>"></textarea>
							...
							<div class="layout-control-group" id="password_text_input_<?php echo $dynamicId; ?>" style="display:none">
								...
								<div class="layout-controls">
									<textarea class="layout-span11" id="ux_password_text_input_<?php echo $dynamicId; ?>" placeholder="<?php _e( "Enter Input Text Style", contact_bank ); ?>" name="ux_password_text_input_<?php echo $dynamicId; ?>"></textarea>
							...
							<div class="layout-control-group" id="password_description_<?php echo $dynamicId; ?>" style="display: none">
								...
								<div class="layout-controls">
									<textarea class="layout-span11" id="ux_password_description_<?php echo $dynamicId; ?>" placeholder="<?php _e( "Enter Description Style", contact_bank ); ?>" name="ux_password_description_<?php echo $dynamicId; ?>"></textarea>
							...
							<div class="layout-control-group">
								...
								<div class="layout-controls">
									<input type="button" class="btn btn-inverse layout-span2" id="ux_button_label_style_<?php echo $dynamicId; ?>" name="ux_button_label_style_<?php echo $dynamicId; ?>" onclick="button_set_outer_label(<?php echo $dynamicId; ?>,15);" value="<?php _e( "Label", contact_bank ); ?>" />
									<input type="button" class="btn btn-inverse layout-span2"  id="ux_button_txt_input_save_<?php echo $dynamicId; ?>" name="ux_button_txt_input_save_<?php echo $dynamicId; ?>" onclick="button_set_txt_input(<?php echo $dynamicId; ?>,15);" value="<?php _e( "Text Input", contact_bank ); ?>" />
									<input type="button" class="btn btn-inverse layout-span2"  id="ux_button_description_style_<?php echo $dynamicId; ?>" name="ux_button_description_style_<?php echo $dynamicId; ?>" onclick="button_set_description(<?php echo $dynamicId; ?>,15);" value="<?php _e( "Description", contact_bank ); ?>" />
								</div>
							</div>
							<div class="layout-control-group">			
...
<script type="text/javascript">
	...
	function save_password_control(dynamicId)
	{
		...
		jQuery("#ux_checkbox_alpha_num_filter_"+dynamicId).prop("checked") == true ? array_controls[dynamicCount].push({"ux_checkbox_alpha_num_filter_": 1}) : array_controls[dynamicCount].push({"ux_checkbox_alpha_num_filter_": 0});
