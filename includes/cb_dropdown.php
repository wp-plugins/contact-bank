			...
			<div class="widget-layout">
				...
				<div class="widget-layout-body">
					...
					<div class="layout-control-group">
						...
						<div class="layout-controls">
							<input type="text" class="layout-span12" id="ux_tooltip_control_<?php echo $dynamicId; ?>" readonly="readonly" placeholder="<?php _e( "This Feature is only available in Paid Premium Version!", contact_bank ); ?>" name="ux_tooltip_control_<?php echo $dynamicId; ?>" value="<?php echo isset($form_settings[$dynamicId]["cb_tooltip_txt"]) ? $form_settings[$dynamicId]["cb_tooltip_txt"] : ""; ?>"/>
						</div>
					</div>
					<div class="layout-control-group">
